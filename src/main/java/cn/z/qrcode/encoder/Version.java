...
public class Version {
     ...
     * `内容字节数`bit数
     */
    public final int ContentBytesBits;
    /**
     * 数据bit数
     * <p>ECI模式指示符+ECI指定符+模式指示符+`内容字节数`bit数+内容+结束符+补齐符</p>
     */
     ...
     * <p>数据bit数+纠错bit数</p>
     */
    public final int DataAndEcBits;
    /**
     * 纠错
     * <p>[纠错块,(块数量,纠错码)]</p>
     */
     ...
     * 数据bit数+纠错bit数
     * <p>索引[版本号]:40</p>
     * <p>数据来源 ISO/IEC 18004-2015 -> 7.1 -> Table 1 -> Data modules except(C)列</p>
     */
    private static final int[] DATA_AND_EC_BITS = { //
    ...
    /**
     * 数据字节数
     * <p>索引[版本号][纠错等级]:40x4</p>
     * <p>数据来源 ISO/IEC 18004-2015 -> 7.4.10 -> Table 7 -> Number of data codewords列</p>
     */
    private static final int[][] DATA_BYTES = { //
            {19, 16, 13, 9}, {34, 28, 22, 16}, {55, 44, 34, 26}, //
            {80, 64, 48, 36}, {108, 86, 62, 46}, // 1-5
            {136, 108, 76, 60}, {156, 124, 88, 66}, {194, 154, 110, 86}, //
            {232, 182, 132, 100}, {274, 216, 154, 122}, // 6-10
            {324, 254, 180, 140}, {370, 290, 206, 158}, {428, 334, 244, 180}, //
            {461, 365, 261, 197}, {523, 415, 295, 223}, // 11-15
            {589, 453, 325, 253}, {647, 507, 367, 283}, {721, 563, 397, 313}, //
            {795, 627, 445, 341}, {861, 669, 485, 385}, // 16-20
            {932, 714, 512, 406}, {1006, 782, 568, 442}, {1094, 860, 614, 464}, //
            {1174, 914, 664, 514}, {1276, 1000, 718, 538}, // 21-25
            {1370, 1062, 754, 596}, {1468, 1128, 808, 628}, {1531, 1193, 871, 661}, //
            {1631, 1267, 911, 701}, {1735, 1373, 985, 745}, // 26-30
            {1843, 1455, 1033, 793}, {1955, 1541, 1115, 845}, {2071, 1631, 1171, 901}, //
            {2191, 1725, 1231, 961}, {2306, 1812, 1286, 986}, // 31-35
            {2434, 1914, 1354, 1054}, {2566, 1992, 1426, 1096}, {2702, 2102, 1502, 1142}, //
            {2812, 2216, 1582, 1222}, {2956, 2334, 1666, 1276}, // 36-40
    };

    /**
     * 纠错
     * <p>索引[版本号][纠错等级][纠错块][(块数量,纠错码)]:40x4x?x2</p>
     * <p>数据来源 ISO/IEC 18004-2015 -> 7.5.1 -> Table 9 -> Number of error correction blocks列 和 Error correction code
     * per block列的k</p>
     */
